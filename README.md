...
- **Currently focusing on:** Advanced Data Structures in **C++**.
- **Building:** From-scratch systems like a **Pathfinding Visualizer (SFML)**.
- **Interests:** Machine Learning, SaaS architecture, and Game Development.
- **Goal:** Transitioning from full-stack development into **AI Engineering**.
...
### Frameworks & Tools
![SFML](https://img.shields.io/badge/SFML-%238CC444.svg?style=for-the-badge&logo=sfml&logoColor=white)
...
* **[Pathfinding Visualizer]([your-link-here](https://github.com/MasonC-Harris/Pathfinding-Visualizer))** - A C++ implementation of Breadth-First Search and Depth-First Search algorithms built with SFML.
